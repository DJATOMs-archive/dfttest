...
//#* LDS: added to prevent the use of some functions
#include	<cassert>
//#* LDS: end of addition
...
/*#* LDS: do not use this function if you want to be compatible with the new
2.6 modes. Use GetRowSize(void) along with GetPlaneHeightSubsampling() instead. */
  __declspec(noinline) int GetRowSize(int plane) const {
    switch (plane) {
//#* LDS: change for 2.6 mode compatibility. Do not use.
    case PLANAR_U: case PLANAR_V: assert (false); if (pitchUV) return row_size>>1; else return 0;
...
/*#* LDS: do not use this function if you want to be compatible with the new
2.6 modes. Use GetHeight(void) along with GetPlaneWidthSubsampling() instead. */
  int GetHeight(int plane) const {  switch (plane) {case PLANAR_U: case PLANAR_V: assert (false); if (pitchUV) return height>>1; return 0;} return height; }
//#* LDS: end of change
